    ...
    PipeDataInCollectionOnce<CalibData>* const calib_data_out)
{
  ...
  // load intrinsic
  calib_data.eigen_intrinsic(0, 0) = intrinsic["fx"].asFloat() / 2.0f; // for 1080p
  calib_data.eigen_intrinsic(1, 1) = intrinsic["fy"].asFloat() / 2.0f;
  calib_data.eigen_intrinsic(0, 2) = intrinsic["cx"].asFloat() / 2.0f;
  calib_data.eigen_intrinsic(1, 2) = intrinsic["cy"].asFloat() / 2.0f;
  ...
  calib_data.eigen_optimal_intrinsic(0, 0) = optimal_intrinsics["fx"].asFloat() / 2.0f;
  calib_data.eigen_optimal_intrinsic(1, 1) = optimal_intrinsics["fy"].asFloat() / 2.0f;
  calib_data.eigen_optimal_intrinsic(0, 2) = optimal_intrinsics["cx"].asFloat() / 2.0f;
  calib_data.eigen_optimal_intrinsic(1, 2) = optimal_intrinsics["cy"].asFloat() / 2.0f;
